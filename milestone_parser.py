...
class MilestoneParser():
    ...
    def get_milestone_stats(self):
        ...
        self.logger.info(f"Start parsing milestone page: {milestone_url} ...")
        bs = trac_html_parser.parse_page(milestone_url)

        # Parse milestone meta info: title, id and timeline
        self.logger.info(f"Parsing milestone meta info (title, id, timeline) ...")
    ...
    def _get_tickets_list(self, bs):
        ...
        trac_html_parser = TracHTMLParser()
        self.logger.info(f"Start parsing tickets list url {tickets_list_url} ...")
    ...
    def _get_tickets_stats_by_category(self, category):
        ...
        self.logger.info(f"Start parsing 'by {category}' url {status_by_category_url} ...")
